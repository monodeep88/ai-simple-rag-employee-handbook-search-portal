# Employee Handbook Search Portal - Intermediate Simple RAG

    ## Project Overview

    Employee Handbook Search Portal - Intermediate Simple RAG is a complete full-stack AI project for **Simple RAG** at **Intermediate** difficulty. It includes a FastAPI backend, a React frontend, sample documents, vector search with ChromaDB support, source citations, timeline logs, structured run storage, Docker files, and tests.

    A practical Employee Handbook Search Portal assistant tailored for Simple RAG workflows.
    ...
    ```text
    ai-simple-rag-employee-handbook-search-portal/
      backend/
        app/
          main.py
          config.py
...
- Retrieve the most relevant source documents
- Apply domain-specific business rules
- Return a cited answer with next actions

    ## Business Rules

    - Always cite source documents when retrieved context is used.
- Escalate unclear, high-risk, or missing-data cases to a human reviewer.
- Prefer concise next actions over generic advice.
