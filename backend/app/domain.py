DOMAIN_SUMMARY = 'A practical Employee Handbook Search Portal assistant tailored for Simple RAG workflows.'
USER_PERSONA = 'Operations user who needs source-grounded answers, checklists, and clear next actions.'
STARTER_QUESTIONS = ['What should I know first about Employee Handbook Search Portal?', 'What policy or evidence supports the recommended next step?', 'Create a checklist for handling this request.']
