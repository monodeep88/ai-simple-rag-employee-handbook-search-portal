...
const STARTER_QUESTIONS = ["What should I know first about Employee Handbook Search Portal?", "What policy or evidence supports the recommended next step?", "Create a checklist for handling this request."];
  ...
  return (
    <main className="page">
      <section className="hero">
        ...
        <h1>Employee Handbook Search Portal</h1>
        <p>A practical Employee Handbook Search Portal assistant tailored for Simple RAG workflows.</p>
        <p className="persona">Built for: Operations user who needs source-grounded answers, checklists, and clear next actions.</p>
      </section>
